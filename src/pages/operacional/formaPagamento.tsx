...
export default function telaFormaPagamento() {
  ...
  return (
    <Layout titulo = "Forma Pagamento" subtitulo = "Grenciamento de Forma de Pagamentos">
      <LayoutCadastros>
      {tabelaVisivel ? (
        <>
        <div className = "flex justify-end">
          <Botao 
            ...
            Nova Forma de Pagamento</Botao>
        </div>
        <TabelaFormaPagamento formaPagamentos = {FormaPagamentos} 
        ...
        <>
        <FormularioFormaPagamento formaPagamento ={FormaPagamento} 
